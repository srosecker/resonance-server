<script lang="ts">
  ...
  let sidebarWidth = $state(256); // 16rem = 256px default
  let queueWidth = $state(320); // 20rem = 320px default
  ...
  <div class="flex-1 flex flex-col min-w-0 bg-base">
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <main class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <div
          class="border-t border-border p-4 bg-mantle/50 backdrop-blur-md z-20"
        >
          <NowPlaying />
        </div>
      </main>
